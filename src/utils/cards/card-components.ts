...
export function getCardComponent(_card: Card) : React.FunctionComponent<React.SVGProps<SVGSVGElement> & {
    title?: string;
}> {
    throw new Error("getCardComponent is not implemented yet");
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function getCardBackComponent(_cardBack: CardBack) : React.FunctionComponent<React.SVGProps<SVGSVGElement> & {
    title?: string;
}> {
    throw new Error("getCardBackComponent is not implemented yet");
